...
const ServicesPage = () => {
  const allServices = [
    ...
    },
    {
      ...
      title: "Leech Therapy",
      description:
        "Ancient medical treatment using medicinal leeches to improve blood circulation and relieve pain.",
    },
    {
      id: "steam-bath",
    ...
    },
    {
      ...
      description:
        "Customized nutritional guidance based on Islamic principles and your specific health needs.",
    },
  ];
    ...
    <section className="my-16 mx-auto max-w-5xl px-4">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="bg-white/90 rounded-lg shadow p-6 flex-1">
          ...
          <ul className="space-y-2 text-amber-900">
            <li className="flex justify-between border-b pb-2">
              <span>Dry Cupping Massage</span> <span>₹ 999</span>
            </li>
            <li className="flex justify-between border-b pb-2">
              <span>Sports Gun Massage with dry cupping</span>{" "}
              <span>₹ 999</span>
            </li>
            <li className="flex justify-between border-b pb-2">
              <span>Sports Scraping Massage with dry cupping</span>{" "}
              <span>₹ 1999</span>
            </li>
            <li className="flex justify-between border-b pb-2">
              <span>Sports Combo Massage with dry cupping</span>{" "}
              <span>₹ 2499</span>
            </li>
            <li className="flex justify-between">
              <span>Facial Massage</span> <span>₹ 499</span>
            </li>
          </ul>
        </div>
        {/* Hijama Therapy */}
        <div className="bg-white/90 rounded-lg shadow p-6 flex-1">
          ...
          <ul className="space-y-2 text-amber-900">
            <li className="flex justify-between border-b pb-2">
              <span>Wet Cupping</span> <span>₹ 999</span>
            </li>
            <li className="flex justify-between border-b pb-2">
              <span>Unlimited Wet Cupping</span> <span>₹ 1499</span>
            </li>
            <li className="flex justify-between border-b pb-2">
              <span>Unlimited Dry & Wet Cupping with Scraping</span>{" "}
              <span>₹ 2499</span>
            </li>
            <li className="flex justify-between">
              <span>Facial Wet Cupping</span> <span>₹ 749</span>
            </li>
          </ul>
        </div>
      </div>
      <div className="flex flex-col md:flex-row gap-6 mt-6">
        ...
        <div className="bg-white/90 rounded-lg shadow p-6 flex-1">
          ...
          <ul className="space-y-2 text-amber-900">
            <li className="flex justify-between border-b pb-2">
              <span>Dry Cup</span> <span>₹ 99</span>
            </li>
            <li className="flex justify-between">
              <span>Wet Cup</span> <span>₹ 149</span>
            </li>
          </ul>
        </div>
        {/* Massage with Steam Therapy */}
        <div className="bg-emerald-900/90 rounded-lg shadow p-6 flex-1">
          <h3 className="text-xl font-semibold text-brand-gold mb-4 text-center">
            Massage with Steam Therapy
          </h3>
          <ul className="space-y-2 text-brand-gold">
            <li className="flex justify-between border-b pb-2">
              <span>Dry Cupping Massage</span> <span>₹ 1749</span>
            </li>
            <li className="flex justify-between border-b pb-2">
              <span>Sports Gun Massage with full body steam</span>{" "}
              <span>₹ 1749</span>
            </li>
            <li className="flex justify-between border-b pb-2">
              <span>Sports Scraping Massage with full body steam</span>{" "}
              <span>₹ 2749</span>
            </li>
            <li className="flex justify-between">
              <span>Sports Combo Massage with full body steam</span>{" "}
              <span>₹ 2999</span>
            </li>
          </ul>
        </div>
      </div>
      <div className="text-center text-gray-500 mt-8 text-xs"></div>
    </section>
  );
  return (
    <Layout>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="max-w-4xl mx-auto mb-12">
          <p className="text-lg mb-6 text-center">
            We offer a comprehensive range of professional hijama and
            complementary therapies to address various health concerns.
          </p>
          <p className="text-lg mb-6 text-center">
            Each treatment is performed following the highest standards of
            hygiene and safety by our qualified practitioners.
          </p>
        </div>
