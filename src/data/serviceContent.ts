...
export const serviceContent: Record<string, ServiceContent> = {
  'dry-cupping': {
    ...
    shortDescription: 'Non-invasive therapy that uses suction to improve blood flow and relieve muscle tension.',
    ...
    seoDescription: 'Experience professional dry cupping therapy in Bangalore at RevivoHeal. Non-invasive treatment for pain relief, improved circulation, and muscle tension. Book your session today.',
    keywords: 'dry cupping Bangalore, cupping therapy, fire cupping, vacuum cupping, muscle pain relief, blood circulation therapy, traditional healing Bangalore'
  },
  
  'wet-cupping': {
    id: 'wet-cupping',
    title: 'Wet Cupping (Hijama) Therapy',
    shortDescription: 'Traditional Hijama therapy that involves creating small incisions for detoxification and healing.',
    ...
    seoTitle: 'Hijama Wet Cupping Therapy in Bangalore | Traditional Islamic Healing - RevivoHeal',
    seoDescription: 'Authentic Hijama wet cupping therapy in Bangalore following Islamic traditions. Professional bloodletting treatment for detoxification and healing. Certified practitioners.',
    keywords: 'Hijama Bangalore, wet cupping therapy, Islamic healing, bloodletting therapy, traditional medicine, detoxification treatment, Sunnah healing Bangalore'
  },

  'sports-massage': {
    id: 'sports-massage',
    title: 'Sports Injury Massage',
    shortDescription: 'Specialized massage techniques to treat and prevent sports-related injuries and improve performance.',
    ...
    seoTitle: 'Sports Injury Massage Therapy in Bangalore | Athletic Recovery Treatment - RevivoHeal',
    seoDescription: 'Professional sports injury massage therapy in Bangalore. Specialized treatment for athletes, injury recovery, and performance enhancement. Expert therapists available.',
    keywords: 'sports massage Bangalore, sports injury treatment, athletic massage therapy, muscle recovery, sports physiotherapy, deep tissue massage athletes'
  },

  'oil-massage': {
    id: 'oil-massage',
    title: 'Deep Tissue Oil Massage',
    shortDescription: 'Therapeutic massage that targets deeper layers of muscle and connective tissue for chronic pain relief.',
    ...
    seoTitle: 'Deep Tissue Oil Massage in Bangalore | Therapeutic Massage Treatment - RevivoHeal',
    seoDescription: 'Professional deep tissue oil massage therapy in Bangalore. Chronic pain relief, muscle tension treatment with therapeutic oils. Expert massage therapists.',
    keywords: 'deep tissue massage Bangalore, therapeutic oil massage, chronic pain relief, muscle tension therapy, relaxation massage, stress relief massage Bangalore'
  },

  'steam-bath': {
    id: 'steam-bath',
    title: 'Steam Bath Therapy',
    shortDescription: 'Relaxing steam treatment that opens pores, improves circulation, and detoxifies the body.',
    ...
    seoTitle: 'Steam Bath Therapy in Bangalore | Detox Steam Treatment - RevivoHeal',
    seoDescription: 'Rejuvenating steam bath therapy in Bangalore. Professional steam treatment for detoxification, relaxation, and health benefits. Book your wellness session.',
    keywords: 'steam bath Bangalore, steam therapy, detox steam treatment, wellness steam bath, relaxation therapy, circulation improvement, skin detox Bangalore'
  }
};
