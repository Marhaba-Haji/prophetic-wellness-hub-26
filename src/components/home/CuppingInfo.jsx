    ...
    <section className="py-20 bg-gradient-to-b from-white to-brand-green/5">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="text-brand-gold uppercase tracking-wider font-medium bg-brand-gold/10 px-4 py-1 rounded-full">
            Understanding Hijama
          </span>
          <h2 className="text-3xl md:text-5xl font-bold text-brand-green mb-6 mt-3">
            What is Cupping Therapy?
          </h2>
          <div className="h-1 w-32 bg-brand-gold mx-auto mb-8"></div>
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            An ancient healing practice that draws stagnant blood and toxins
            from the body while stimulating circulation and promoting natural
            healing.
          </p>
        </div>
              ...
              <div className="space-y-6">
                <Card className="overflow-hidden hover:shadow-lg transition-shadow border-t-4 border-t-brand-green">
                  <CardContent className="p-6">
                    ...
                    <p className="mb-4">
                      Cupping therapy (Hijama) has a rich history spanning
                      thousands of years across different civilizations. It was
                      practiced in ancient Chinese, Egyptian, and Greek medicine
                      as early as 1550 BCE.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="overflow-hidden hover:shadow-lg transition-shadow border-t-4 border-t-brand-gold">
                  <CardContent className="p-6">
                    ...
                    <p className="mb-4">
                      In Islamic tradition, Hijama gained prominence through the
                      teachings of Prophet Muhammad (PBUH), who recommended it
                      as a beneficial treatment. The word "Hijama" comes from
                      the Arabic word "hajm" meaning "sucking" or "drawing out".
                    </p>
                ...
                <Card className="overflow-hidden hover:shadow-lg transition-shadow border-t-4 border-t-brand-green">
                  <CardContent className="p-6">
                    ...
                    <p>
                      In traditional Chinese medicine, cupping has been
                      practiced for over 2,000 years. It is believed to balance
                      yin and yang energies within the body and to promote the
                      flow of "qi" (life energy) through meridian pathways.
                    </p>
                  </CardContent>
                </Card>
                ...
                <div className="grid grid-cols-1 gap-4 mt-6">
                  ...
                  {[
                    ...
                    <div
                      key={index}
                      className="flex items-start p-3 rounded-lg bg-white shadow-md hover:shadow-lg transition-all duration-300"
                    >
                      <div className="bg-brand-green text-white rounded-full h-6 w-6 flex items-center justify-center mr-3 flex-shrink-0">
                        {index + 1}
                      </div>
                      <div>
                        <h5 className="font-medium text-brand-green text-sm">
                          {item.step}
                        </h5>
