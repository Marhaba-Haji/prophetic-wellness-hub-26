...
const benefits = [
  ...
  },
  {
    ...
    description: "Calms the nervous system, reduces anxiety, and promotes overall relaxation."
  }
];
    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-brand-green mb-4">Key Benefits of Hijama Therapy</h2>
          ...
          {benefits.map((benefit, index) => (
            <Card key={index} className="border border-gray-200 hover:shadow-lg transition-shadow duration-300">
              <CardContent className="p-6 text-center">
                <div className="text-brand-green mx-auto mb-4">{benefit.icon}</div>
